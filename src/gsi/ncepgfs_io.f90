...
!   get file names
    ...
    if(lhourly_da) then
       ...
       if(.not. liau .and.      lfirst_hrly_analysis) fname_nstges = 'nstf02'
       if(.not. liau .and..not. lfirst_hrly_analysis) fname_sfcges = 'sfcf01'
...
!
       do k = 1, n_ens
          ...
          if (lhourly_da) then
             ...
             if(.not. liau .and.      lfirst_hrly_analysis) fname_nstges = 'nstf02_mem'//cmember
             if(.not. liau .and.      lfirst_hrly_analysis) fname_sfcges = 'sfcf02_mem'//cmember
             if(.not. liau .and..not. lfirst_hrly_analysis) fname_nstges = 'nstf01_mem'//cmember
             if(.not. liau .and..not. lfirst_hrly_analysis) fname_sfcges = 'sfcf01_mem'//cmember
          else
...
!
       if (lhourly_da) then
          ...
          if(.not. liau .and.      lfirst_hrly_analysis) fname_nstges = 'nstf02_ensmean'
          if(.not. liau .and.      lfirst_hrly_analysis) fname_sfcges = 'sfcf02_ensmean'
          if(.not. liau .and..not. lfirst_hrly_analysis) fname_nstges = 'nstf01_ensmean'
          if(.not. liau .and..not. lfirst_hrly_analysis) fname_sfcges = 'sfcf01_ensmean'
       else
